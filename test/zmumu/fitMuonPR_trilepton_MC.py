...
process.TnP_Muon_ID = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    InputFileNames = cms.vstring(
      'file:/data1/Users/jskim/TagAndProbe/tree/TnPTree_Madgraph_Moriond17_dXYSIG_ADDED_reweighted_SKIMMED.root'
    ),
    OutputFileName = cms.string(
      "/data1/Users/jskim/TagAndProbe/results/TnP_Muon_PR_MC.root"
    ),
    ...
    Efficiencies = cms.PSet(
        HN_TRI_TIGHT_pt_eta = cms.PSet(
            ...
            BinnedVariables = cms.PSet(
                ...
                pt     = cms.vdouble( 5., 15., 20., 25., 30., 35., 45., 60., 80., 100., 200. ),
                ## flags and conditions required at the denominator, 
                combRelIsoPF04dBeta = cms.vdouble( 0., 0.4 ), ## Loose ID
            ),
