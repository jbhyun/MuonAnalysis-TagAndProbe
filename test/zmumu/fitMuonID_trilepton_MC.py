...
process.TnP_Muon_ID = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    InputFileNames = cms.vstring(
      'file:/data4/Users/jskim/TagAndProbe/tree/TnPTree_Madgraph_Moriond17_dXYSIG_ADDED_reweighted_SKIMMED.root'
    ),
    OutputFileName = cms.string(
      "/data4/Users/jskim/TagAndProbe/results/TnP_Muon_ID_MC.root"
    ),
    ...
    Efficiencies = cms.PSet(
        HN_TRI_TIGHT_pt_eta = cms.PSet(
            ...
            BinToPDFmap = cms.vstring(
                ...
                "*eta_bin0*pt_bin8*", "vpvPlusExpo",
                "*eta_bin1*pt_bin0*", "vpvPlusExpo",
                "*eta_bin1*pt_bin1*", "vpvPlusExpo",
                "*eta_bin1*pt_bin2*", "vpvPlusCMSbeta0p2",
                "*eta_bin1*pt_bin3*", "vpvPlusCMSbeta0p2",
                "*eta_bin1*pt_bin4*", "vpvPlusCMSbeta0p2",
                ...
                "*eta_bin2*pt_bin1*", "vpvPlusExpo",
                "*eta_bin2*pt_bin2*", "vpvPlusCheb",
                "*eta_bin2*pt_bin3*", "vpvPlusCMSbeta0p2",
                "*eta_bin2*pt_bin4*", "vpvPlusCheb",
                "*eta_bin2*pt_bin5*", "vpvPlusCheb",
                "*eta_bin2*pt_bin6*", "vpvPlusCheb",
                "*eta_bin2*pt_bin7*", "vpvPlusCheb",
                "*eta_bin2*pt_bin8*", "vpvPlusCheb",
                "*eta_bin3*pt_bin0*", "vpvPlusCheb",
                "*eta_bin3*pt_bin1*", "vpvPlusCheb",
                "*eta_bin3*pt_bin2*", "vpvPlusCheb",
                "*eta_bin3*pt_bin3*", "vpvPlusCheb",
                "*eta_bin3*pt_bin4*", "vpvPlusCheb",
                "*eta_bin3*pt_bin5*", "vpvPlusCheb",
                "*eta_bin3*pt_bin6*", "vpvPlusCheb",
                "*eta_bin3*pt_bin7*", "vpvPlusExpo",
                "*eta_bin3*pt_bin8*", "vpvPlusExpo",
            ),
        )
    ),
