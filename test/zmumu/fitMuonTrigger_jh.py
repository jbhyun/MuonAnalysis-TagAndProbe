...
process.TnP_Muon_Trigger = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    PDFs = cms.PSet(
        ...
        vpvPlusExpoPassFail3 = cms.vstring(
            ...
            "SUM::signalPass(vFracPass[0.8,0,1]*signalPass1, signalPass2)",
            "Voigtian::signalFail1(mass, meanFail1[91.1,80.1,150.1], width[2.495], sigmaFail1[2.5,1,6])",
            "Voigtian::signalFail2(mass, meanFail2[91.1,80.1,150.1], width,        sigmaFail2[5,1,15])",
            "SUM::signalFail(vFracFail[0.8,0,1]*signalFail1, signalFail2)",
            "Exponential::backgroundPass(mass, lp[-0.1,-1,0.1])",
            "Exponential::backgroundFail(mass, lf[-0.1,-1,0.1])",
            "efficiency[0.9,0,1]",
        ...
        vpvPlusExpoPassFail4 = cms.vstring(
            ...
            "Voigtian::signalPass2(mass, meanPass2[91.1,80.1,150.1], width,        sigmaPass2[5,1,10])",
            "SUM::signalPass(vFracPass[0.8,0,1]*signalPass1, signalPass2)",
            "Voigtian::signalFail1(mass, meanFail1[91.1,80.1,150.1], width[2.495], sigmaFail1[2.5,1,8])",
            "Voigtian::signalFail2(mass, meanFail2[91.1,80.1,150.1], width,        sigmaFail2[5,1,15])",
            "SUM::signalFail(vFracFail[0.8,0,1]*signalFail1, signalFail2)",
            "Exponential::backgroundPass(mass, lp[-0.1,-1,0.1])",
            "Exponential::backgroundFail(mass, lf[-0.1,-1,0.1])",
        ...
        vpvPlusExpoPassFail5 = cms.vstring(
            ...
            "Voigtian::signalPass2(mass, meanPass2[91.1,80.1,150.1], width,        sigmaPass2[5,1,10])",
            "SUM::signalPass(vFracPass[0.8,0,1]*signalPass1, signalPass2)",
            "Voigtian::signalFail1(mass, meanFail1[91.1,80.1,150.1], width[2.495], sigmaFail1[2.5,0.1,8])",
            "Voigtian::signalFail2(mass, meanFail2[91.1,80.1,150.1], width,        sigmaFail2[5,0.1,15])",
            "SUM::signalFail(vFracFail[0.8,0,1]*signalFail1, signalFail2)",
            "Exponential::backgroundPass(mass, lp[-0.1,-1,0.1])",
            "Exponential::backgroundFail(mass, lf[-0.1,-1,0.1])",
            "efficiency[0.9,0,1]",
        ...
        voigtPlusExpoPassFail4 = cms.vstring(
            "Voigtian::signalPass(mass, meanPass[91.1,80.1,110.1], width[2.495], sigmaPass[2.5,1,6])",
            "Voigtian::signalFail(mass, meanFail[91.1,80.1,110.1], width[2.495], sigmaFail[2, 0.1,8])",
            "Exponential::backgroundPass(mass, lp[-0.1,-1,0.1])",
            "Exponential::backgroundFail(mass, lf[-0.1,-1,0.1])",
            "efficiency[0.9,0,1]",
            "signalFractionInPassing[0.9]"
        ...
        voigtPlusExpoPassFail5 = cms.vstring(
            "Voigtian::signalPass(mass, meanPass[91.1,80.1,150.1], width[2.495], sigmaPass[2.5,1,6])",
            "Voigtian::signalFail(mass, meanFail[91.1,80.1,120.1], width[2.495], sigmaFail[1.5,0.1,4])",
            "Exponential::backgroundPass(mass, lp[-0.1,-1,0.1])",
            "Exponential::backgroundFail(mass, lf[-0.1,-1,0.1])",
            "efficiency[0.9,0,1]",
            "signalFractionInPassing[0.9]"
  ...
  if Period=="BCDEF":
    if "MC" in infile:
      process.TnP_Muon_Trigger.Efficiencies.HN_TRI_TIGHT_Trigger_pt_eta.BinToPDFmap = cms.vstring(
        SignalShape+"PlusExpo",
        "*abseta_bin0*pt_bin4*", SignalShape+"PlusExpo", ## PlusExpoPassFail:worse -> PlusExpo
        "*abseta_bin1*pt_bin3*", SignalShape+"PlusExpoPassFail",
        "*abseta_bin1*pt_bin5*", SignalShape+"PlusExpoPassFail2", ## PlusExpoPassFail: need mor narrow peak -> PlusExpoPassFail2
        "*abseta_bin2*pt_bin5*", SignalShape+"PlusExpoPassFail",
        "*abseta_bin2*pt_bin10*", SignalShape+"PlusExpo", ## PlusExpoPassFail: hmm -> PlusExpoPassFail2: worse.. -> PlusExpoPassFail4 -> PlusExpo
        "*abseta_bin2*pt_bin11*", SignalShape+"PlusExpoPassFail",
      ...
      process.TnP_Muon_Trigger.Efficiencies.HN_TRI_TIGHT_Trigger_pt_eta.BinToPDFmap = cms.vstring(
        ...
        "*abseta_bin1*pt_bin4*", SignalShape+"PlusExpoPassFail2", ## PlusExpoPassFail: need mor narrow peak -> PlusExpoPassFail2
  ...
  if Period=="GH":
    if "MC" in infile:
      process.TnP_Muon_Trigger.Efficiencies.HN_TRI_TIGHT_Trigger_pt_eta.BinToPDFmap = cms.vstring(
        ...
        "*abseta_bin0*pt_bin4*", SignalShape+"PlusExpo", ## PlusExpoPassFail:worse -> PlusExpo
        "*abseta_bin1*pt_bin3*", SignalShape+"PlusExpoPassFail",
        "*abseta_bin1*pt_bin4*", SignalShape+"PlusExpo", ## PlusExpoPassFail:worse -> PlusExpo
        "*abseta_bin1*pt_bin5*", SignalShape+"PlusExpoPassFail5", ## PlusExpoPassFail: need mor narrow peak -> PlusExpoPassFail2: arg -> PlusExpoPassFail5
        "*abseta_bin2*pt_bin5*", SignalShape+"PlusExpoPassFail",
        "*abseta_bin2*pt_bin11*", SignalShape+"PlusExpoPassFail2", ## PlusExpoPassFail: need mor narrow peak -> PlusExpoPassFail2
      )
    else:
      process.TnP_Muon_Trigger.Efficiencies.HN_TRI_TIGHT_Trigger_pt_eta.BinToPDFmap = cms.vstring(
        SignalShape+"PlusExpo",
        ...
        "*abseta_bin0*pt_bin1*", SignalShape+"PlusExpo", ## PlusExpoPassFail: need mor narrow peak -> PlusExpoPassFail2 -> PlusExpoPassFail4 -> PlusExpo
        "*abseta_bin1*pt_bin5*", SignalShape+"PlusExpoPassFail",
        "*abseta_bin3*pt_bin10*", SignalShape+"PlusExpoPassFail3", ## PlusExpoPassFail:hmm ->PlusExpoPassFail2:hmm... -> PlusExpoPassFail3
      )
...
if PassingProbeTrigger=="Mu8_OR_TkMu8":
  ...
  if Period=="BCDEF":
    if "MC" in infile:
      process.TnP_Muon_Trigger.Efficiencies.HN_TRI_TIGHT_Trigger_pt_eta.BinToPDFmap = cms.vstring(
        ...
        "*abseta_bin2*pt_bin5*", SignalShape+"PlusExpo", ## PlusExpoPassFail:worse -> PlusExpo:hmm try 4 -> PlusExpoPassFail4 -> PlusExpo
        "*abseta_bin2*pt_bin6*", SignalShape+"PlusExpoPassFail3", ## PlusExpoPassFail:error bar -> PlusExpoPassFail3 :hmm try 4 -> PlusExpoPassFail4 -> PlusExpoPassFail3
      )
    else:
      process.TnP_Muon_Trigger.Efficiencies.HN_TRI_TIGHT_Trigger_pt_eta.BinToPDFmap = cms.vstring(
        SignalShape+"PlusExpo",
  ...
  if Period=="GH":
    if "MC" in infile:
      process.TnP_Muon_Trigger.Efficiencies.HN_TRI_TIGHT_Trigger_pt_eta.BinToPDFmap = cms.vstring(
        SignalShape+"PlusExpo",
        "*abseta_bin2*pt_bin6*", SignalShape+"PlusExpoPassFail2", ## PlusExpoPassFail: need mor narrow peak -> PlusExpoPassFail2
      ...
      process.TnP_Muon_Trigger.Efficiencies.HN_TRI_TIGHT_Trigger_pt_eta.BinToPDFmap = cms.vstring(
        ...
        "*abseta_bin0*pt_bin0*tag_pt_bin0*", SignalShape+"PlusExpoPassFail", ## PlusExpoPassFail: need mor narrow peak -> PlusExpoPassFail2 -> PlusExpoPassFail3 -> PlusExpoPassFail4 -> PlusCheb_2nd -> PlusCMS -> just use PlusExpoPassFail
        "*abseta_bin3*pt_bin5*", SignalShape+"PlusExpoPassFail",
      )
#
#
